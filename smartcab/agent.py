...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.trial += 1
            #using update decay in notebook
    ...
    def get_maxQ(self, state):
        ...
        action_value_pairs = self.Q[state]

        # this return which action should take
        #maxQ = max(action_value_pairs,key=action_value_pairs.get)

        maxQ = max(action_value_pairs.values())
